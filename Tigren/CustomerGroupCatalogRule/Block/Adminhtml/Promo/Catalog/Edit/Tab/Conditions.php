 ...
 */
namespace Tigren\CustomerGroupCatalogRule\Block\Adminhtml\Promo\Catalog\Edit\Tab;
...
class Conditions extends Generic implements TabInterface
{
     ...
     */
    protected function addTabToForm($model, $fieldsetId = 'conditions_fieldset', $formName = 'customergr_catalogrule_rule_form')
    {
        /** @var \Magento\Framework\Data\Form $form */
