...
class ConfigProvider extends ConfigProviderAbstract
{
    ...
    const XPATH_BATCH_DUPLICATE_SIZE = 'batch_duplicate_size';
    const XPATH_BATCH_DUPLICATE_METHOD_NAME_POSTFIX = 'batch_duplicate_method_name_postfix';
    const STATUS_FOR_DUPLICATE_METHOD = 'status_for_duplicate_method';
    const XPATH_MSI_ALGORITHM = 'msi_algorithm';
    /**#@-*/
