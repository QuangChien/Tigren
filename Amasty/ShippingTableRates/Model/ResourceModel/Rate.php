...
class Rate extends AbstractDb
{
    ...
    const SOURCES_TABLE = 'amasty_table_rate_sources';
    const FIND_PATTERN = '~^[\p{L}\p{Z}-]+$~u';

    const SOURCES_REQUEST_KEY = 'amstrates_sources';
     ...
     * @return $this
     */
    private function addSourceFilters(Select $select, RateRequest $request): self
    {
